...
public class BlockBreaker extends BlockMachine {
    ...
    public BlockBreaker(String unlocalizedName) {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(TYPE, MachineTypes.BASIC).withProperty(FACING, EnumFacing.NORTH).withProperty(ACTIVATED, Boolean.valueOf(false)));
    }
    ...
    public int getMetaFromState(IBlockState state) {
        MachineTypes type = (MachineTypes) state.getValue(TYPE);
    ...
    public IBlockState getStateFromMeta(int meta) {
        MachineTypes type = MachineTypes.values()[(int)(meta / EnumFacing.values().length) % MachineTypes.values().length]; //Gets the type from the meta
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
        ...
        if(!worldIn.isRemote) {
            playerIn.openGui(ZeroBit.instance, GuiHandler.BLOCK_BREAKER, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
