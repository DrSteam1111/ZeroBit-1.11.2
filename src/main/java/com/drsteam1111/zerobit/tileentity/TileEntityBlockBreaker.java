...
import com.drsteam1111.zerobit.blocks.BlockBreaker;
...
public class TileEntityBlockBreaker extends TileEntity implements ITickable, ICapabilityProvider {
    ...
    public TileEntityBlockBreaker() {
        this.worker = new Worker(ZbConfig.machineCooldownBasic, () -> {
    ...
    public void updateCooldownCap() {
        ...
        if (this.world.getBlockState(pos).getValue(BlockBreaker.TYPE) == MachineTypes.BASIC)
            cap = ZbConfig.machineCooldownBasic;
        else
            cap = ZbConfig.machineCooldownAdvanced;
     ...
     * {@link com.drsteam1111.zerobit.client.gui.GuiBlockBreaker}
     *
     * @param player
     *            The player to test
